...
namespace Fantasy
{
    ...
    public class NLog : ILog
    {
        ...
        {
            _logger.Trace("[{0}] {1}", category, message);
        }
        ...
        {
            _logger.Trace("[{0}] " + message, Prepend(category, args));
        }
        ...
        public void Warning(string category, string message, params object[] args)
        {
            _logger.Warn("[{0}] " + message, Prepend(category, args));
        }
        ...
        {
            _logger.Info("[{0}] " + message, Prepend(category, args));
        }
        ...
        {
            _logger.Debug("[{0}] " + message, Prepend(category, args));
        }
        ...
        {
            _logger.Error("[{0}] " + message, Prepend(category, args));
        }
