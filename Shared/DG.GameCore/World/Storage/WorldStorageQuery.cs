...
{
    public GameWorldObservation(long entityEnumerationCount, long entityEnumerationSortCount, long componentQueryCount, long tryGetComponentCount, long hasComponentCount, long spatialQueryCount, long touchedSnapshotBuildCount, long fullSnapshotBuildCount, long deltaFlushCount, long touchedDiagnosticCount, long queryTimeTicks, long candidateCount, long commitCount, long deltaMaterializationCount)
    {
        ...
        QueryTimeTicks = queryTimeTicks;
        CandidateCount = candidateCount;
        CommitCount = commitCount;
        DeltaMaterializationCount = deltaMaterializationCount;
    }
    ...
    public long DeltaMaterializationCount { get; }
}
...
internal sealed class GameWorldObservationCounters
{
    ...
    public long DeltaMaterializationCount;
...
public readonly struct AutoMoveActionCandidate
{
    public AutoMoveActionCandidate(long entityId, long createdTick, int costTicks, long readyTick)
    {
        EntityId = entityId;
...
public readonly struct PushOnEnterActionCandidate
{
    public PushOnEnterActionCandidate(long sourceEntityId, long subjectEntityId, ActionSpecId specId, Direction direction, long createdTick, int costTicks)
    {
