...
public sealed class EffectSpecRegistry
{
    ...
    public static EffectSpecRegistry CreateFirstSliceDefaults()
    {
        ...
        {
            new EffectSpec("temporary_blocking", EffectKind.Blocking, EffectTargetBinding.TargetEntity, EffectDurationPolicy.InfiniteUntilRemove, EffectStackPolicy.RefreshDuration, EffectRemovePolicy.ExplicitOnly, 0, 1, DirectionMask.None, true, true, WorldTag.None, "temporary_blocking"),
            new EffectSpec("temporary_auto_move", EffectKind.AutoMove, EffectTargetBinding.TargetEntity, EffectDurationPolicy.InfiniteUntilRemove, EffectStackPolicy.RefreshDuration, EffectRemovePolicy.ExplicitOnly, 0, 1, DirectionMask.None, true, true, WorldTag.None, "temporary_auto_move"),
            new EffectSpec("temporary_pushable", EffectKind.Pushable, EffectTargetBinding.TargetEntity, EffectDurationPolicy.InfiniteUntilRemove, EffectStackPolicy.RefreshDuration, EffectRemovePolicy.ExplicitOnly, 0, 1, DirectionMask.None, true, true, WorldTag.None, "temporary_pushable"),
            ...
            new EffectSpec("temporary_immobile", EffectKind.MovementPermission, EffectTargetBinding.TargetEntity, EffectDurationPolicy.InfiniteUntilRemove, EffectStackPolicy.RefreshDuration, EffectRemovePolicy.ExplicitOnly, 0, 1, DirectionMask.None, false, false, WorldTag.None, "temporary_immobile"),
            new EffectSpec("temporary_tag_super_armor", EffectKind.Tag, EffectTargetBinding.TargetEntity, EffectDurationPolicy.InfiniteUntilRemove, EffectStackPolicy.RefreshDuration, EffectRemovePolicy.ExplicitOnly, 0, 1, DirectionMask.None, true, true, WorldTag.StateSuperArmor, "temporary_tag"),
            new EffectSpec("temporary_rotate_pivot", EffectKind.RotatePivot, EffectTargetBinding.TargetEntity, EffectDurationPolicy.InfiniteUntilRemove, EffectStackPolicy.RefreshDuration, EffectRemovePolicy.ExplicitOnly, 0, 1, DirectionMask.None, true, true, WorldTag.None, "temporary_rotate_pivot")
        });
    }
}
}
